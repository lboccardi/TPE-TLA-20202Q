...
static const yytype_uint8 yyrline[] =
{
     ...
     107,   108,   112,   113,   114,   115,   116,   121,   122,   123,
...
{
  "$end", "error", "$undefined", "DIGIT", "ALPHA", "SPACE_ALPHA", "INT",
  "STRING", "PLUS", "MINUS", "TIMES", "DIV", "END", "OPEN_P", "CLOSE_P",
  "CONDITIONAL", "EXEC", "END_EXEC", "IF", "ELSE", "ESCAPE", "WHILE", "L",
  "G", "LE", "GE", "EQ", "NOT", "OR", "AND", "ASSIGN", "RETURN", "MAIN",
  "STDIN", "STDOUT", "FUNCTION", "COMMA", "ARRAY", "$accept", "start",
  "function", "type", "params", "args", "call", "program", "out", "var",
  "operation", "assignment", "rule", "arrow", "operator", "op", YY_NULLPTR
};
#endif
...
{
       3,   -58,   -58,    -1,    27,     3,    -6,    10,   -58,   -58,
      36,    -2,    21,    46,    18,    17,    38,    53,    43,    57,
      58,    48,    48,   -58,   -58,    21,   -58,    73,    61,    66,
      17,    17,    50,    63,    47,    10,   -58,    10,    56,    65,
      62,   -58,    44,   -58,    37,    73,   -58,   -58,   -58,   -58,
     -58,   -58,   -58,   -58,   -58,   -58,   -58,   -58,    21,   -58,
     -58,    71,   -58,   -58,    59,    67,    10,    48,   -58,   -58,
      82,    74,   -58,    48,   -58,    46,    21,    75,    78,    17,
      17,   -58,   -58,    37,    55,    76,   -58,    37,    79,    88,
      10,   -58,   -58,   -58,    56,    10,   -58,   -58,    15,   -58,
     -58,    87,   -58,   -58,    89,   -58,    10,    90,    10,   -58
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,    13,     0,    35,    34,     0,    37,     0,     0,     0,
      24,    24,     0,     0,    29,    21,     2,    21,     9,    34,
       0,    12,    10,    31,    33,     0,    49,    50,    52,    51,
      41,    42,    43,    44,    45,    46,    47,    48,     0,    40,
      18,     0,    25,    22,     0,     0,    21,     0,    16,    15,
       0,     0,    14,    13,    28,     0,     0,     0,     0,    24,
      24,    20,    30,    33,     7,     0,    11,    33,     0,     0,
      21,    26,    23,    27,     9,    21,    32,    36,     0,    19,
       8,     0,    39,    38,     0,     4,    21,     0,    21,    17
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -58,   101,   -58,     0,    14,    39,   -14,   -34,   -12,   -58,
     -57,    -9,   -19,   -58,    64,   -25
};
...
{
       6,    68,    59,    69,    28,     6,    45,    41,    43,     1,
       2,    21,    42,    44,    11,     7,     1,     2,    62,    63,
      59,    30,    31,    12,    23,    24,    93,     8,    22,    10,
      96,    29,    81,   102,    25,     3,   103,    32,    70,    77,
      20,    13,    34,    14,    15,    46,    47,    48,    49,    23,
      24,    23,    39,    82,    64,    65,    99,    88,    83,    41,
      36,   101,     1,     2,    42,    35,    87,    91,    92,    37,
      61,    38,   107,    60,   109,    66,    72,    67,    21,    79,
      73,    46,    47,    48,    49,    78,    84,    80,    85,    89,
      90,    94,    95,    97,    70,    50,    51,    52,    53,    54,
      55,    56,    57,    98,   105,   106,     9,   108,   100,    76,
       0,     0,    86
};

static const yytype_int8 yycheck[] =
{
       0,    35,    27,    37,    13,     5,    25,    21,    22,     6,
       7,    13,    21,    22,     4,    16,     6,     7,    30,    31,
      45,     4,     5,    13,     3,     4,    83,     0,    30,    35,
      87,    13,    66,    18,    13,    32,    21,    20,    38,    58,
       4,    31,     4,    33,    34,     8,     9,    10,    11,     3,
       4,     3,     4,    67,     4,     5,    90,    76,    67,    73,
      17,    95,     6,     7,    73,    12,    75,    79,    80,    12,
       4,    13,   106,    12,   108,    12,    14,    30,    13,    20,
      36,     8,     9,    10,    11,    14,     4,    20,    14,    14,
      12,    36,    16,    14,    94,    22,    23,    24,    25,    26,
      27,    28,    29,    15,    17,    16,     5,    17,    94,    45,
      -1,    -1,    73
};
...
{
       0,     6,     7,    32,    39,    40,    41,    16,     0,    39,
      35,     4,    13,    31,    33,    34,    41,    44,    45,    47,
       4,    13,    30,     3,     4,    13,    49,    50,    49,    13,
       4,     5,    20,    46,     4,    12,    17,    12,    13,     4,
      43,    44,    49,    44,    49,    50,     8,     9,    10,    11,
      22,    23,    24,    25,    26,    27,    28,    29,    52,    53,
      12,     4,    46,    46,     4,     5,    12,    30,    45,    45,
      41,    42,    14,    36,    48,    53,    52,    50,    14,    20,
      20,    45,    44,    49,     4,    14,    43,    49,    50,    14,
      12,    46,    46,    48,    36,    16,    48,    14,    15,    45,
      42,    45,    18,    21,    51,    17,    16,    45,    17,    45
};
...
#line 1568 "y.tab.c"
  ...
  case 20:
#line 107 "grammar.y"
                                                { (yyval.stringValue) = malloc(strlen((yyvsp[-2].stringValue))*2+5+strlen((yyvsp[0].stringValue))+ 11); char * print = printfParser((yyvsp[-2].stringValue)); sprintf((yyval.stringValue), "printf(%s);\n%s", print, (yyvsp[0].stringValue)); add((yyval.stringValue),true); free(print);}
#line 1574 "y.tab.c"
    break;
...
#line 1610 "y.tab.c"
  ...
  case 27:
#line 121 "grammar.y"
                                                { (yyval.stringValue) = malloc(strlen((yyvsp[-4].stringValue))+strlen((yyvsp[-3].stringValue))+3+strlen((yyvsp[-1].stringValue))+strlen((yyvsp[0].stringValue))); sprintf((yyval.stringValue),"%s %s=%s%s",(yyvsp[-4].stringValue),(yyvsp[-3].stringValue),(yyvsp[-1].stringValue),(yyvsp[0].stringValue));add((yyval.stringValue),true); addVar((yyvsp[-3].stringValue), (yyvsp[-4].stringValue));}
#line 1616 "y.tab.c"
    break;
...
#line 1622 "y.tab.c"
  ...
  case 29:
#line 123 "grammar.y"
                                                { (yyval.stringValue) = malloc(strlen((yyvsp[-1].stringValue))+strlen((yyvsp[0].stringValue))+2); sprintf((yyval.stringValue),"%s %s",(yyvsp[-1].stringValue),(yyvsp[0].stringValue));add((yyval.stringValue),true); addVar((yyvsp[0].stringValue), (yyvsp[-1].stringValue));}
#line 1628 "y.tab.c"
    break;

  case 30:
#line 124 "grammar.y"
                                                { (yyval.stringValue) = malloc(strlen((yyvsp[-3].stringValue))+strlen((yyvsp[-2].stringValue))+3+strlen((yyvsp[0].stringValue))); sprintf((yyval.stringValue),"%s %s=%s",(yyvsp[-3].stringValue),(yyvsp[-2].stringValue),(yyvsp[0].stringValue)); add((yyval.stringValue),true); addVar((yyvsp[-2].stringValue), (yyvsp[-3].stringValue));}
#line 1634 "y.tab.c"
    break;
